...
# snapshot_path = '/hpcstor6/scratch01/s/sanghyuk.kim001/snapshot/temp'
...
#     if os.path.exists(f'{snapshot_path}/performance/{target_network}/{m}_metrics.json') is not True:
